...
\begin{frame}{memory\_graph Debugger Setup}
  ...
  \item add line: \\ \ \ \ {\footnotesize \mintinline{python}{import memory_graph}}
  \item set a breakpoint and start the debugger
  \item add watch: \\ \ \ \ {\footnotesize \mintinline{python}{memory_graph.render(memory_graph.get_call_stack_vscode(), 'my_graph.pdf')}}
  ...
  \item or add watch: \\ \ \ \ {\footnotesize \mintinline{python}{memory_graph.render(memory_graph.get_call_stack_vscode(), 'my_graph.png')}}
  \end{itemize}
  \vspace{2em}
\end{frame}
...
\begin{frame}{memory\_graph Non-Debugger Setup}
  ...
  \item add line where you want to graph: \\
    \ \ \ {\footnotesize \mintinline{python}{memory_graph.show(memory_graph.get_call_stack())}}\\
    \ \ \ {\footnotesize \mintinline{python}{memory_graph.render(memory_graph.get_call_stack(), 'my_graph.png')}}\\
