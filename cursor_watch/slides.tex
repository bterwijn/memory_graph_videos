...
\makebox[\textwidth]{%
  \begin{tabular}{c c c}
    \begin{tabular}{c}
      \includegraphics[height=0.25\textwidth]{figures/cursor.png} \\
      Cursor AI
    \end{tabular}
    &
...
\begin{frame}{Cursor AI with 'memory\_graph'}
  ...
  \item set a breakpoint, start the debugger, and add watch: \\
    \ \ \ {\footnotesize \mintinline{python}{mg.render(mg.stack_cursor(), 'memory_graph.pdf')}} \\
    \ \ \ {\footnotesize \mintinline{python}{mg.cursor_watch()}}
...
\ \ \ {\footnotesize \mintinline{python}{mg.render(mg.stack_cursor(), 'memory_graph.svg')}} \\
\ \ \ {\footnotesize \mintinline{python}{mg.render(mg.stack_cursor(), 'memory_graph.png')}}
  \end{itemize}
\end{frame}
