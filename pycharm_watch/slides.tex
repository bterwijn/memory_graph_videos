...
\usepackage{minted}
\title{PyCharm with 'memory\_graph'}
\author{Bas Terwijn}
\titlegraphic{
...
\makebox[\textwidth]{%
  \begin{tabular}{c c c}
    \begin{tabular}{c}
      \includegraphics[height=0.25\textwidth]{figures/pycharm.png} \\
      PyCharm
    \end{tabular}
    &
    ...
    &
    \begin{tabular}{c}
      \includegraphics[height=0.25\textwidth]{../vscode_watch/figures/memory_graph.png} \\
       memory\_graph
    \end{tabular}
    \\
...
\begin{frame}{PyCharm with 'memory\_graph'}
  ...
  \item set a breakpoint, start the debugger, and add watch: \\
    ...
    \ \ \ {\footnotesize \mintinline{python}{mg.pycharm_watch()}}
...
\ \ \ {\footnotesize \mintinline{python}{mg.render(mg.stack_pycharm(), 'memory_graph.svg')}} \\
\ \ \ {\footnotesize \mintinline{python}{mg.render(mg.stack_pycharm(), 'memory_graph.png')}}
  \end{itemize}
\end{frame}
