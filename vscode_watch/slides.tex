...
\makebox[\textwidth]{%
  \begin{tabular}{c c c}
    \begin{tabular}{c}
      \includegraphics[width=0.25\textwidth]{figures/vscode_logo.png} \\
      Visual Studio Code
    \end{tabular}
    &
    ...
    &
    \begin{tabular}{c}
      \includegraphics[width=0.25\textwidth]{figures/memory_graph.png} \\
      memory\_graph
    \end{tabular}
    \\
...
\begin{frame}{VS Code with 'memory\_graph'}
  ...
  \item set a breakpoint, start the \href{https://code.visualstudio.com/docs/python/debugging}{\texttt{vscode debugger}} and add watch: \\
    ...
    \ \ \ {\footnotesize \mintinline{python}{mg.vscode()}}
...
\ \ \ {\footnotesize \mintinline{python}{mg.vscode('memory_graph.svg')}} \\
\ \ \ {\footnotesize \mintinline{python}{mg.vscode('memory_graph.png')}}
  \end{itemize}
\end{frame}
