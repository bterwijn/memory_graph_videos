...
\makebox[\textwidth]{%
  \begin{tabular}{c c c}
    \begin{tabular}{c}
      \includegraphics[height=0.25\textwidth]{figures/vscode_logo.png} \\
      Visual Studio Code
    \end{tabular}
    &
    %\raisebox{0.08\textwidth}{\includegraphics[height=0.08\textwidth]{figures/plus.png}}
    \raisebox{-0.02\textwidth}{\includegraphics[height=0.06\textwidth]{figures/plus.png}}
    &
    \begin{tabular}{c}
      \includegraphics[height=0.25\textwidth]{figures/memory_graph.png} \\
       memory\_graph
    \end{tabular}
    \\
...
\begin{frame}{VS Code with 'memory\_graph'}
  ...
  \item set a breakpoint, start the \href{https://code.visualstudio.com/docs/python/debugging}{\texttt{vscode debugger}} and add watch: \\
    \ \ \ {\footnotesize \mintinline{python}{mg.render(mg.stack_vscode(), 'memory_graph.pdf')}} \\
    \ \ \ {\footnotesize \mintinline{python}{mg.vscode_watch()}}
...
\ \ \ {\footnotesize \mintinline{python}{mg.render(mg.stack_vscode(), 'memory_graph.svg')}} \\
\ \ \ {\footnotesize \mintinline{python}{mg.render(mg.stack_vscode(), 'memory_graph.png')}}
  \end{itemize}
\end{frame}
